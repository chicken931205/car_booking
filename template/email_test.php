...
?>
								...
								<tr>
									<td <?php echo $this->data['style']['header']; ?>><?php esc_html_e('Information','car-park-booking-system'); ?></td>
								</tr>
								<tr><td <?php echo $this->data['style']['separator'][3]; ?>><td></tr>
								<tr>
									<td>
										<?php esc_html_e('Test message sending via "Car Park Booking System for WordPress" plugin.','car-park-booking-system'); ?>
									</td>
								</tr>
